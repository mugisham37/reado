                        ...
                        <div data-delay="4000" data-animation="slide" className="slider scroll-animation w-slider"
                            ...
                            <div className="slider-mask is-testimonial w-slider-mask" id="w-slider-mask-0">
                                <div className="slide-item is-testimonial w-slide" aria-label="1 of 3" role="group"
                                    style={{transition: 'all, transform 500ms', transform: 'translateX(-1152px)', opacity: 1}}
                                    aria-hidden="true">
                                    <div className="testimonial_slider" aria-hidden="true">
                                        ...
                                        <div className="testimonial_info" aria-hidden="true">
                                            ...
                                            <div aria-hidden="true">"We launched our Mexico City operations in 30 days –
                                                no local entity needed. Their payroll and benefits infrastructure saved
                                                us $280K in setup costs, and their talent retention rate is 40% higher
                                                than industry average."</div>
                                ...
                                <div className="slide-item is-testimonial w-slide" aria-label="2 of 3" role="group"
                                    ...
                                    <div className="testimonial_slider">
                                        ...
                                        <div className="testimonial_info">
                                            ...
                                            <div>"In 2024, we onboarded 12 pre-vetted LatAm specialists through Hirely –
                                                from paralegals to senior developers. Not only did we cut payroll costs
                                                by 72%, but the talent outperformed our local hires in productivity.
                                                Their end-to-end compliance support eliminated our legal headaches."
                                            </div>
                            ...
                            <div className="hide w-slider-nav w-round">
                                <div className="w-slider-dot" data-wf-ignore="" aria-label="Show slide 1 of 3"
                                    aria-pressed="false" role="button" tabIndex={-1}
                                    style={{marginLeft: '3px', marginRight: '3px'}}></div>
                                <div className="w-slider-dot w-active" data-wf-ignore="" aria-label="Show slide 2 of 3"
